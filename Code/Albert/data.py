...
class Instance(object):
    def __init__(self, tokenizer, sentence_pack, args):
        ...
        self.token_range = []
        self.albert_tokens = tokenizer.encode(self.sentence)
        self.length = len(self.albert_tokens)
        self.albert_tokens_padding = torch.zeros(args.max_sequence_len).long()
        ...
        for i in range(self.length):
            self.albert_tokens_padding[i] = self.albert_tokens[i]
...
def load_data_instances(sentence_packs, args):
    instances = list()
    tokenizer = AlbertTokenizer.from_pretrained(args.albert_tokenizer_path)
...
class DataIterator(object):
    ...
    def get_batch(self, index):
        ...
        for i in range(index * self.args.batch_size,
            ...
            albert_tokens.append(self.instances[i].albert_tokens_padding)
        ...
        albert_tokens = torch.stack(albert_tokens).to(self.args.device)
        ...
        return sentence_ids, albert_tokens, lengths, masks, sens_lens, token_ranges, aspect_tags, tags
