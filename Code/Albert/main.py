...
from model import MultiInferalBert
import utils
...
def train(args):
    ...
    model = MultiInferalBert(args).to(args.device)

    optimizer = torch.optim.Adam([
        {'params': model.albert.parameters(), 'lr': 1e-5},
    ...
    for i in range(args.epochs):
        ...
        if joint_f1 > best_joint_f1:
            model_path = args.model_dir + 'albert' + args.task + '.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--albert_tokenizer_path', type=str,
                        default="albert-base-v2",
                        help='pretrained bert tokenizer path')
    parser.add_argument('--albert_feature_dim', type=int, default=768,
