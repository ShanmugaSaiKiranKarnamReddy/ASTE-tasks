...
class Instance(object):
    def __init__(self, tokenizer, sentence_pack, args):
        ...
        self.token_range = []
        self.xlnet_tokens = tokenizer.encode(self.sentence)
        #print(self.xlnet_tokens)
        self.length = len(self.xlnet_tokens)
        #print(self.length)
        self.xlnet_tokens_padding = torch.zeros(args.max_sequence_len).long()
        #print(self.xlnet_tokens_padding)
        ...
        for i in range(self.length):
            self.xlnet_tokens_padding[i] = self.xlnet_tokens[i]
...
class DataIterator(object):
    ...
    def get_batch(self, index):
        ...
        for i in range(index * self.args.batch_size,
            ...
            xlnet_tokens.append(self.instances[i].xlnet_tokens_padding)
        ...
        xlnet_tokens = torch.stack(xlnet_tokens).to(self.args.device)
        ...
        return sentence_ids,sentences, xlnet_tokens, lengths, masks, sens_lens, token_ranges, aspect_tags, tags
