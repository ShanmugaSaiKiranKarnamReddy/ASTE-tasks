...
from model import MultiInferRoBerta
import utils
...
def train(args):
    ...
    model = MultiInferRoBerta(args).to(args.device)
    ...
    for i in range(args.epochs):
        ...
        if joint_f1 > best_joint_f1:
            model_path = args.model_dir + 'roberta' + args.task + '.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--roberta_model_path', type=str,
                        default="pretrained/roberta-base-uncased",
                        help='pretrained roberta model path')
    parser.add_argument('--roberta_tokenizer_path', type=str,
                        default="roberta-base",
                        help='pretrained roberta tokenizer path')
    parser.add_argument('--roberta_feature_dim', type=int, default=768,
                        help='dimension of pretrained roberta feature')
